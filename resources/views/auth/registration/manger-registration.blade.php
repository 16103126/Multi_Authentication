...
@section('title', 'Manger Registration')
...
<div class="container">
    <div class="row" style="margin-top: 45px; margin-left: 300px;">
        <div class="col-md-6 col-md-offset-2">
            <h4>Manger Registration</h4><hr>
            <form action="{{ route('manger.registration.submit') }}" method="post">
                ...
                <br>
                <a href="{{ route('manger.login') }}">I already have an account, sign in</a>
            </form>
        </div>
    </div>
</div>
